...
% Further modifications for MAST10007 by Anthony Morphett, November 2017
...
txt.axstr=Axstr;
txt.normstr=normstr;
h.xtext = text( -1.68*s, .9*s, txt.xstr,'fontweight','bold','VerticalAlignment', 'bottom', ...
      'Color', xcolor );
h.axtext = text( -1.05 * s, .6*s, txt.axstr,'fontweight','bold','HorizontalAlignment', 'right', ...
      'VerticalAlignment', 'bottom', 'Color', Axcolor);
h.normtext = text(-1.42 * s, .3*s, txt.normstr,'fontweight','bold','HorizontalAlignment', 'right', ...
...
if h.svd
   ...
   h.textangle=text(pt(1),pt(2),txt.theta);
   h.ytext = text( -1.68*s, -.3*s, txt.ystr,'fontweight','bold','VerticalAlignment', 'bottom', ...
      'Color', xcolor );
   h.aytext = text( -1.05* s, -.6*s, txt.aystr,'fontweight','bold','HorizontalAlignment', 'right', ...
      'VerticalAlignment', 'bottom', 'Color', Axcolor);
   h.ynormtext = text(-1.42 * s,-.9*s, txt.ynormstr,'fontweight','bold','HorizontalAlignment', 'right', ...
      'VerticalAlignment', 'top', 'Color', Axcolor );
...
h.mark = line(v(1),v(2),'marker','.','color',color);
